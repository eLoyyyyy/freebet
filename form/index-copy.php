				...
				<div class="loginmodal-container">
					...
					<form class="form-horizontal" id="claim-form" method="POST" action="index.php"> <!-- action="index.php"-->
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="userid" pattern="^[A-Za-z0-9 ]*[A-Za-z0-9][A-Za-z0-9 ]*$" placeholder="User ID" required>
							</div>
						</div>
						<div class="form-group">
							<label for="inputPassword3" class="col-sm-3 control-label">Nama di Facebook</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="username" pattern="^[A-Za-z0-9 _]*[A-Za-z0-9][A-Za-z0-9 _]*$" placeholder="Name" required>
							</div>
						</div>
						<div class="form-group">
							<label for="inputPassword4" class="col-sm-3 control-label">Facebook URL</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="facebook_url" pattern="(?:(?:http|https):\/\/)?(?:www.)?facebook.com\/(?:(?:\w)*#!\/)?(?:pages\/)?(?:[?\w\-]*\/)?(?:profile.php\?id=(?=\d.*))?([\w\-]*)?" placeholder="Facebook URL" required>
							</div>
						</div>
						<div class="form-group">
