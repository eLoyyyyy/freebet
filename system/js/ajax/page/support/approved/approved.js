...
jQuery("#grid-data").on("loaded.rs.jquery.bootgrid", function () {
	...
	formatters: {
		...
		"commands": function(column, row){
					return "<button type=\"button\" class=\"btn btn-xs btn-default command-onprocess\" data-entries-id=\"" + row.entries_id + "\" data-toggle=\"modal\" data-target=\"#bryan\"><span class=\"fa fa-refresh fa-2x\"></span></button> ";
		},
	}
});
...
/*function onprocess(entry_id, process){
	...
	jq.ajax({
		url: "../js/ajax/page/support/approved/approved.php",
		type: "POST",
		data: dataArray
...
function onprocess(entry_id, process){
	...
	var url = domain + "js/ajax/page/support/approved/approved.php";
