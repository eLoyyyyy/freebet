...
if(isset($_SESSION['account_id'])){
	...
	$sql_1 = "UPDATE fb_form_data SET fb_form_data.app_status = '$process', fb_form_data.reason_type = '$reject_reason', fb_form_data.message = '".$tblTxtArea."', fb_form_data.account_id = '$account_id' WHERE fb_form_data.entries_id = '$entry_id' AND fb_form_data.app_status = 2";
